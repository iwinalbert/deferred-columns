...
extern unique_ptr<FunctionData> DeferredScanBind(ClientContext &context, TableFunctionBindInput &input, vector<LogicalType> &return_types, vector<string> &names);
...
static void LoadInternal(ExtensionLoader &loader) {
    ...
    TableFunction deferred_scan("deferred_scan", {LogicalType::VARCHAR}, DeferredScanFunction, DeferredScanBind, DeferredScanInit);
