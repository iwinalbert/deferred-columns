...
static void SumCIUpdate(Vector inputs[], AggregateInputData &aggr_input_data, idx_t input_count, Vector &state_vector, idx_t count) {
...
AggregateFunction GetSumCIAggregate() {
    auto fun = AggregateFunction("sum_ci", {LogicalType::DOUBLE, LogicalType::DOUBLE}, LogicalType::VARCHAR,
                                 AggregateFunction::StateSize<SumCIState>,
                                 AggregateFunction::StateInitialize<SumCIState, SumCIFunction>,
                                 SumCIUpdate,
                                 AggregateFunction::StateCombine<SumCIState, SumCIFunction>,
                                 AggregateFunction::StateFinalize<SumCIState, string_t, SumCIFunction>,
